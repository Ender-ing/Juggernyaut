...
namespace Diagnostics {
    Diagnostic getGenTokenDiagnostic(antlr4::Token *token) {
        Diagnostic diag;
    ...
    Diagnostic getGenNodeDiagnostic(antlr4::tree::TerminalNode *node) {
        Diagnostic diag;
    ...
    Diagnostic getGenRuleDiagnostic(antlr4::ParserRuleContext *context) {
        Diagnostic diag;
