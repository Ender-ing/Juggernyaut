...
function(manage_symbolic_links POST_TARGET JUG_COMMAND_NAME)
    if(WIN32)
        ...
        set(SYMBOLIC_LINKS_COMMAND_EXTRA start /wait powershell -Command "Start-Process powershell -Wait -Verb RunAs -ArgumentList \\\"-Command cd '${CMAKE_RUNTIME_OUTPUT_DIRECTORY}' \; New-Item -Path ${JUG_COMMAND_NAME}.exe -ItemType SymbolicLink -Value ${POST_TARGET}.exe \\\" ")
    else()
...
function(create_symbolic_link TARGET SOURCE LINK)
    if(WIN32)
        set(SYMBOLIC_LINKS_COMMAND_LINK start /wait powershell -Command "Start-Process powershell -Wait -Verb RunAs -ArgumentList \\\"-Command cd '${CMAKE_RUNTIME_OUTPUT_DIRECTORY}' \; New-Item -Path ${LINK}.exe -ItemType SymbolicLink -Value ${SOURCE}.exe \\\" ")
    else()
