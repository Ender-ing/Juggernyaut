...
if(DEFINED JUG_BUILD_PLATFORM_NAME)
    set(JUG_BINARY_PLATFORM ${JUG_BUILD_PLATFORM_NAME})
else()
...
macro(set_modified_dist SUBFOLDER)
    ...
    if (WIN32)
        set(LIB_OUT_FOLDER_NAME bin)
    else()
        set(LIB_OUT_FOLDER_NAME lib)
    endif()

    # Set the desired CMake binary output directory
    set(CMAKE_RUNTIME_OUTPUT_DIRECTORY ${JUG_OUT_FINAL_DIR}${APPEND}/bin)
    set(CMAKE_LIBRARY_OUTPUT_DIRECTORY ${JUG_OUT_FINAL_DIR}${APPEND}/${LIB_OUT_FOLDER_NAME})
    ...
    set(CMAKE_RUNTIME_OUTPUT_DIRECTORY_RELEASE ${JUG_BINARY_DIR}/Release/${JUG_BINARY_PLATFORM}${APPEND}/bin)
    set(CMAKE_LIBRARY_OUTPUT_DIRECTORY_DEBUG ${JUG_BINARY_DIR}/Debug/${JUG_BINARY_PLATFORM}${APPEND}/${LIB_OUT_FOLDER_NAME})
