...
if((DEFINED CMAKE_GENERATOR_PLATFORM) AND (NOT "${CMAKE_GENERATOR_PLATFORM}" STREQUAL ""))
    set(JUG_GENERATOR_PLATFORM "${CMAKE_GENERATOR_PLATFORM}")
elseif((DEFINED CMAKE_UNIX_GENERATOR_PLATFORM) AND (NOT "${CMAKE_UNIX_GENERATOR_PLATFORM}" STREQUAL ""))
    set(JUG_GENERATOR_PLATFORM "${CMAKE_UNIX_GENERATOR_PLATFORM}")
else((NOT DEFINED JUG_GENERATOR_PLATFORM) OR ("${JUG_GENERATOR_PLATFORM}" STREQUAL ""))
    message(WARNING "[BUILD] 'JUG_GENERATOR_PLATFORM' not set. Auto-detecting local architecture...")
    get_local_arch(JUG_GENERATOR_PLATFORM)
endif()
set(CMAKE_GENERATOR_PLATFORM "${JUG_GENERATOR_PLATFORM}")
set(CMAKE_UNIX_GENERATOR_PLATFORM "${JUG_GENERATOR_PLATFORM}")
