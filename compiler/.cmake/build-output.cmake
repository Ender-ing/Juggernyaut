...
function(attach_manifest_data TARGET)
    ...
    # Set versioning info
    get_ini_value(${JUG_MANIFEST_FILE} "TARGET:${TARGET}" "VERSION" INI_VERSION)
    #get_ini_value(${JUG_MANIFEST_FILE} "TARGET:${TARGET}" "SOVERSION" INI_SOVERSION)
    ...
    get_ini_value(${JUG_MANIFEST_FILE} "TARGET:${TARGET}" "DESCRIPTION" IN_BIN_DESCRIPTION)
